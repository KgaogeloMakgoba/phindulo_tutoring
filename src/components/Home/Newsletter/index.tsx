        ...
        <section id="about">
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
                    <div className={`col-span-12 ${isProd ? 'bg-newsletter-bg-2' : 'bg-newsletter-bg'} bg-cover bg-center bg-no-repeat min-h-[400px] lg:min-h-[500px]`}>
                        <div className="mb-10 mt-16 lg:mx-64 lg:my-24 px-4 max-w-3xl mx-auto">
                            <h3 className="text-2xl sm:text-3xl md:text-5xl text-center font-semibold text-white mb-3">About Us.</h3>
                            <h3 className="text-sm sm:text-base md:text-lg font-medium text-white/95 text-center mb-8 leading-relaxed break-all">
